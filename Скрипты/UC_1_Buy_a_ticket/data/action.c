Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=128701.200162009zzcAAzHpQiDDDDDDDQHcAptAHQ", ENDITEM, 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=030;472;05/08/2020", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=First", ENDITEM, 
		"Name=seatPref", "Value=Window", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=firstName", "Value=Nicola", ENDITEM, 
		"Name=lastName", "Value=Prynin", ENDITEM, 
