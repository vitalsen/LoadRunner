Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=128698.582341029zzVQQDDpDcQVzzzHDQHVQpfQQQHf", ENDITEM, 
	...
	web_submit_data("itinerary.pl", 
		...
		"Name=flightID", "Value=1-7-JB", ENDITEM, 
		"Name=flightID", "Value=1-1557-JB", ENDITEM, 
		"Name=flightID", "Value=1-2340-JB", ENDITEM, 
